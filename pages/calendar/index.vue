...
const calendarOptions = ref({
  ...
  dayHeaderContent: (args) => {
    ...
    const headerWeek = document.createElement('span')
  ...
  eventClassNames: function (info) {
    ...
    if (groups.length) {
      result =
        (result && groups.includes(info.event.extendedProps.group)) ||
  ...
  <div class="content_wrap">
    <div class="calendar_layout">
      <div class="calendar_left">
        <!-- mini calendar -->
        <FullCalendar id="miniCalendar" ref="miniCalendarRef" :options="miniCalendarOptions" />
        <!-- //mini calendar -->
          ...
          <div class="calendar_option">
            <div class="option">
              <label class="switch_wrap">
                ...
                <span class="switch">
                  <input id="" type="checkbox" class="event_filter" name="event_filter" data-type="" value="true"
              ...
              <ul>
                <li>
                  <label class="label_ckeck">
                    <input id="calendarGroup1" type="checkbox" class="event_filter" name="event_filter"
                      data-type="group" value="calendarGroup1" checked=""
                      @change="handleEventFilter('calendarGroup1')" />
                    <span class="check_mark" style="background: #285ff6; border-color: #285ff6" />
                    <span class="check_text">할일</span>
                  </label>
                </li>
                <li>
                  <label class="label_ckeck">
                    <input id="calendarGroup2" type="checkbox" class="event_filter" name="event_filter"
                      data-type="group" value="calendarGroup2" checked=""
                      @change="handleEventFilter('calendarGroup2')" />
                    <span class="check_mark" style="background: #33ad6e; border-color: #33ad6e" />
                    <span class="check_text">상품 출고</span>
                  </label>
                </li>
                <li>
                  <label class="label_ckeck">
                    <input id="calendarGroup3" type="checkbox" class="event_filter" name="event_filter"
                      data-type="group" value="calendarGroup3" checked=""
                      @change="handleEventFilter('calendarGroup3')" />
                    <span class="check_mark" style="background: #f9a580; border-color: #f9a580" />
                    <span class="check_text">상품 오픈</span>
                  </label>
                </li>
                <li>
                  <label class="label_ckeck">
                    <input id="calendarGroup4" type="checkbox" class="event_filter" name="event_filter"
                      data-type="group" value="calendarGroup4" checked=""
                      @change="handleEventFilter('calendarGroup4')" />
                    <span class="check_mark" style="background: #ebbf60; border-color: #ebbf60" />
          ...
          <div class="calendar_option toggleWrap" :class="{ active: subscribuIsOpen }">
            ...
            <div class="cont toggleCont">
              <ul>
                <li>
                  <label class="label_ckeck">
                    <input id="calendarGroup5" type="checkbox" class="event_filter" name="event_filter"
                      data-type="group" value="calendarGroup5" checked=""
                      @change="handleEventFilter('calendarGroup5')" />
                    <span class="check_mark" style="background: #69d2e2; border-color: #69d2e2" />
                    <span class="check_text">[구독] 쇼핑몰 프로모션</span>
                  </label>
                </li>
                <li>
                  <label class="label_ckeck">
                    <input id="calendarGroup6" type="checkbox" class="event_filter" name="event_filter"
                      data-type="group" value="calendarGroup6" checked=""
                      @change="handleEventFilter('calendarGroup6')" />
                    <span class="check_mark" style="background: #003557; border-color: #003557" />
                    <span class="check_text">[구독] 이벤트 모니터링</span>
                  </label>
                </li>
                <li>
                  <label class="label_ckeck">
                    <input id="calendarGroup7" type="checkbox" class="event_filter" name="event_filter"
                      data-type="group" value="calendarGroup7" checked=""
                      @change="handleEventFilter('calendarGroup7')" />
                    <span class="check_mark" style="background: #9065e6; border-color: #9065e6" />
          ...
          <div class="calendar_option">
            ...
            <a href="#registerCalendar" class="btnModalOpen option">
              <label class="switch_wrap">
                <strong>프로모션</strong>
                <span class="switch">
                  <input id="" type="checkbox" class="event_filter" name="event_filter" data-type="" value="" />
                  <span class="slider" />
                </span>
              </label>
            </a>
      ...
      <div class="calendar_view">
        ...
        <!-- 달력 -->
        <FullCalendar id="calendar" ref="calendarRef" :options="calendarOptions" />
        <!-- //달력 -->

        <!-- 이벤트 상세보기 레이어 -->
        <calendar-layer-components v-model="eventsInfoIsOpen" :events-info="eventsInfo" />
        <!-- //이벤트 상세보기 레이어 -->
      </div>
      <!-- //calendar_view -->
    </div>
