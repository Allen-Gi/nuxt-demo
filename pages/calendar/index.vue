    ...
    <div class="calendar_layout">
      <div class="calendar_left">
        ...
        <div id="calendarFilter">
          ...
          <div
            class="calendar_option toggleWrap"
            :class="{ active: myGroupIsOpen }"
          >
          ...
          <div
            class="calendar_option toggleWrap"
            :class="{ active: subscribuIsOpen }"
          >
            <div class="tit">
              <button
                type="button"
                class="btnOpen"
                @click="subscribuIsOpenToggle()"
              >
      ...
      <div class="calendar_view">
        ...
        <!-- 이벤트 상세보기 레이어 -->
        <calendar-layer-components
          v-model="eventsInfoIsOpen"
