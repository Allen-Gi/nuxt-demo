    ...
    <div class="setup_content">
      ...
      <div class="section first">
        ...
        <dl class="cell">
          ...
          <dd>
            <radio-components
              v-model="settingInfo.start_calendar"
              name="start_calendar"
              :options="[
                { label: '월', value: 'M' },
                { label: '주', value: 'W' },
        ...
        <dl class="cell">
          ...
          <dd>
            <radio-components
              v-model="settingInfo.start_week"
              name="start_week"
              :options="[
                { label: '일요일', value: 'S' },
                { label: '월요일', value: 'M' },
        ...
        <dl class="cell">
          ...
          <dd>
            <radio-components
              v-model="settingInfo.use_secondary_calendar"
        ...
        <dl class="cell slt">
          ...
          <dd>
            ...
            <select-components
              v-model="settingInfo.display_limit"
              name="display_limit"
              :options="[
                { label: '5개', value: '5' },
                { label: '10개', value: '10' },
      ...
      <div class="section">
        ...
        <dl class="cell">
          ...
          <dd>
            <radio-components
              v-model="settingInfo.front_use_permission"
            ...
            <div
              v-if="settingInfo.front_use_permission === 'F'"
              id="frontGrade"
              class="radio_cont"
            >
              <checkbox-components
                v-model="settingInfo.front_permission"
        ...
        <dl class="cell">
          ...
          <dd>
            <radio-components
              v-model="settingInfo.front_start_calendar"
        ...
        <dl class="cell">
          ...
          <dd>
            <radio-components
              v-model="settingInfo.front_start_week"
        ...
        <dl class="cell">
          ...
          <dd>
            <div class="source_copy">
              <div class="sourcebox">
                <textarea id="sourceCopy" readonly>
